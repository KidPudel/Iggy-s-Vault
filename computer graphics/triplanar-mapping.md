...
- Texture appears to be "painted on the world" — moving the object causes the texture to swim unless locked to object space
...
- Why does full triplanar require three texture samples and how does that compare to a single UV-mapped sample in GPU cost?
