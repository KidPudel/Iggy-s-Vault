...
Utilize go's great strength of [[goroutines]] in a smart and clean way. Think of the optimizations, and centralizations, so here you can use errgroup, [[CS/architecture/event bus]], echo framework.
